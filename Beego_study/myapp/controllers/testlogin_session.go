...
type TestLoginSessionMainController struct {//首字母必须要大写
	beego.Controller
}

func (c *TestLoginSessionMainController) Login() {
	...
	if name != ""{
		...
		c.Ctx.WriteString(`<html><form action="http://127.0.0.1:8080/test_login_Session" method="post">
...
func (c *TestLoginSessionMainController) Post() {
	u := UserInfo{}
